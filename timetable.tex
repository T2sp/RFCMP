...
\begin{table}[H]
    ...
    \begin{tabularx}{0.75\linewidth}{llY}
        ...
        15:00-16:30 &川平将志 &スペクトル系列と（Beyond）the Standard Model \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.75\linewidth}{llY}
        ...
        &\multicolumn{1}{l}{\textbf{タイトル}} \\
        \midrule
        10:00-11:30 &宮澤仁 &Recent development of Seiberg-Witten theory and low-dimensional topology \\
        11:30-13:00 & &昼休憩 \\
        13:00-14:30 &宮澤仁 &Recent development of Seiberg-Witten theory and low-dimensional topology \\
        15:00-16:30 &大森寛太郎 &高階線形代数入門 \\
        17:00-18:30 &大森寛太郎 &高階線形代数入門 \\
    \end{tabularx}
\end{table}%
