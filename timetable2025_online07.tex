...
\title{Recent and Future Context for Mathematical Physics \\ Online Seminar}
\author{会場：Zoom Meeting}
\date{2025年7月20日 (日) 13:30-17:00}
\maketitle
...
\begin{table}[H]
    ...
    \begin{tabularx}{0.75\linewidth}{llY}
        ...
        \midrule
        13:30-17:00 &高間俊至 &テンソル圏と state-sum TQFT \\
    \end{tabularx}
\end{table}%
